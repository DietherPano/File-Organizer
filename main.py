...
from tkinter import filedialog,messagebox,PhotoImage,Image
import os
import shutil
import json
import threading
...
class File_Organizer(tk.Tk):
    ...
    def main_window(self):
        # directory_frame = tk.Frame(self,bg='#AFDDE5')
        ...
        # menu_frame = tk.Frame(self,bg='#002379',width=248,height=500)
        ...
        # .pack(anchor='center',side='left',padx=(248,0))
        ...
        # .pack(anchor='center',side='right',padx=(0,247))
            ...
            for file_type_dictionary in [file_types['file_types'], file_types['code_file_types'], file_types['database_file_types']]:
                for file_type, extensions in file_type_dictionary.items():
                    if file_extension in extensions:
                        ...
                        # Add (1) to File if have a duplicate
